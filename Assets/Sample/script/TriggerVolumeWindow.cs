...
namespace Sample
{
    public class TriggerVolumeWindow : MonoBehaviour, ISystemTrayItemEventListener
    {
        #region Attributes
        ...
        public void OnTriggerEnter(Collider other)
        {
            ...
            if (go != null && go.tag.Equals("Player") && mlPlayer.IsLocal && !m_IsRegistered)
            {
                ...
                bool activateWindowEventRaisedSuccessfully = m_SystemUIHandler.TryActivateWindow(m_TrayItemSO.ItemID);
            }
        }
        ...
        public void OnTriggerExit(Collider other)
        {
            ...
            if (go != null && go.tag.Equals("Player") && mlPlayer.IsLocal && m_IsRegistered)
            {
                ...
                //check the current state of the window if open then 

                // Deactivate window, if it is a window item.
                bool deactivateWindowEventRaisedSuccessfully = m_SystemUIHandler.TryDeactivateWindow(m_TrayItemSO.ItemID);
